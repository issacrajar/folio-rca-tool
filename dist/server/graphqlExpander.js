...
const expandedQueries = { guest: "", group: "", house: "" };
/**
 ...
 */
function extractNamedGqlQuery(source, varName) {
 ...
 */
function resolveAllRefs(content, localLiterals, depth = 0) {
    if (depth > 10)
        return content;
 ...
 */
export function getExpandedQuery(accountType) {
    return expandedQueries[accountType] || "";
}
/**
 * Build query variables template for account type
 */
export function buildVariablesTemplate(accountType, params) {
