 ...
 */
export function saveRules(text: string): void {
 ...
 */
export function parseRules(text: string): UserRule[] {
 ...
 */
function matchesConditions(transaction: Record<string, any>, conditions: { field: string; value: string }[]): boolean {
 ...
 */
export function applyUserRules(transaction: Record<string, any>): {
